...
pub mod i_morpho_base {
    ...
    pub static IMORPHOBASE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct IMorphoBase<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for IMorphoBase<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for IMorphoBase<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for IMorphoBase<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for IMorphoBase<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IMorphoBase))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IMorphoBase<M> {
    ...
    impl ::ethers::contract::EthLogDecode for IMorphoBaseEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = AccrueInterestFilter::decode_log(log) {
                return Ok(IMorphoBaseEvents::AccrueInterestFilter(decoded));
            }
            if let Ok(decoded) = BorrowFilter::decode_log(log) {
                return Ok(IMorphoBaseEvents::BorrowFilter(decoded));
            }
            if let Ok(decoded) = CreateMarketFilter::decode_log(log) {
                return Ok(IMorphoBaseEvents::CreateMarketFilter(decoded));
            }
            if let Ok(decoded) = EnableIrmFilter::decode_log(log) {
                return Ok(IMorphoBaseEvents::EnableIrmFilter(decoded));
            }
            if let Ok(decoded) = EnableLltvFilter::decode_log(log) {
                return Ok(IMorphoBaseEvents::EnableLltvFilter(decoded));
            }
            if let Ok(decoded) = FlashLoanFilter::decode_log(log) {
                return Ok(IMorphoBaseEvents::FlashLoanFilter(decoded));
            }
            if let Ok(decoded) = IncrementNonceFilter::decode_log(log) {
                return Ok(IMorphoBaseEvents::IncrementNonceFilter(decoded));
            }
            if let Ok(decoded) = LiquidateFilter::decode_log(log) {
                return Ok(IMorphoBaseEvents::LiquidateFilter(decoded));
            }
            if let Ok(decoded) = RepayFilter::decode_log(log) {
                return Ok(IMorphoBaseEvents::RepayFilter(decoded));
            }
            if let Ok(decoded) = SetAuthorizationFilter::decode_log(log) {
                return Ok(IMorphoBaseEvents::SetAuthorizationFilter(decoded));
            }
            if let Ok(decoded) = SetFeeFilter::decode_log(log) {
                return Ok(IMorphoBaseEvents::SetFeeFilter(decoded));
            }
            if let Ok(decoded) = SetFeeRecipientFilter::decode_log(log) {
                return Ok(IMorphoBaseEvents::SetFeeRecipientFilter(decoded));
            }
            if let Ok(decoded) = SetOwnerFilter::decode_log(log) {
                return Ok(IMorphoBaseEvents::SetOwnerFilter(decoded));
            }
            if let Ok(decoded) = SupplyFilter::decode_log(log) {
                return Ok(IMorphoBaseEvents::SupplyFilter(decoded));
            }
            if let Ok(decoded) = SupplyCollateralFilter::decode_log(log) {
                return Ok(IMorphoBaseEvents::SupplyCollateralFilter(decoded));
            }
            if let Ok(decoded) = WithdrawFilter::decode_log(log) {
                return Ok(IMorphoBaseEvents::WithdrawFilter(decoded));
            }
            if let Ok(decoded) = WithdrawCollateralFilter::decode_log(log) {
                return Ok(IMorphoBaseEvents::WithdrawCollateralFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for IMorphoBaseEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AccrueInterestFilter> for IMorphoBaseEvents {
        fn from(value: AccrueInterestFilter) -> Self {
            Self::AccrueInterestFilter(value)
        }
    }
    impl ::core::convert::From<BorrowFilter> for IMorphoBaseEvents {
        fn from(value: BorrowFilter) -> Self {
            Self::BorrowFilter(value)
        }
    }
    impl ::core::convert::From<CreateMarketFilter> for IMorphoBaseEvents {
        fn from(value: CreateMarketFilter) -> Self {
            Self::CreateMarketFilter(value)
        }
    }
    impl ::core::convert::From<EnableIrmFilter> for IMorphoBaseEvents {
        fn from(value: EnableIrmFilter) -> Self {
            Self::EnableIrmFilter(value)
        }
    }
    impl ::core::convert::From<EnableLltvFilter> for IMorphoBaseEvents {
        fn from(value: EnableLltvFilter) -> Self {
            Self::EnableLltvFilter(value)
        }
    }
    impl ::core::convert::From<FlashLoanFilter> for IMorphoBaseEvents {
        fn from(value: FlashLoanFilter) -> Self {
            Self::FlashLoanFilter(value)
        }
    }
    impl ::core::convert::From<IncrementNonceFilter> for IMorphoBaseEvents {
        fn from(value: IncrementNonceFilter) -> Self {
            Self::IncrementNonceFilter(value)
        }
    }
    impl ::core::convert::From<LiquidateFilter> for IMorphoBaseEvents {
        fn from(value: LiquidateFilter) -> Self {
            Self::LiquidateFilter(value)
        }
    }
    impl ::core::convert::From<RepayFilter> for IMorphoBaseEvents {
        fn from(value: RepayFilter) -> Self {
            Self::RepayFilter(value)
        }
    }
    impl ::core::convert::From<SetAuthorizationFilter> for IMorphoBaseEvents {
        fn from(value: SetAuthorizationFilter) -> Self {
            Self::SetAuthorizationFilter(value)
        }
    }
    impl ::core::convert::From<SetFeeFilter> for IMorphoBaseEvents {
        fn from(value: SetFeeFilter) -> Self {
            Self::SetFeeFilter(value)
        }
    }
    impl ::core::convert::From<SetFeeRecipientFilter> for IMorphoBaseEvents {
        fn from(value: SetFeeRecipientFilter) -> Self {
            Self::SetFeeRecipientFilter(value)
        }
    }
    impl ::core::convert::From<SetOwnerFilter> for IMorphoBaseEvents {
        fn from(value: SetOwnerFilter) -> Self {
            Self::SetOwnerFilter(value)
        }
    }
    impl ::core::convert::From<SupplyFilter> for IMorphoBaseEvents {
        fn from(value: SupplyFilter) -> Self {
            Self::SupplyFilter(value)
        }
    }
    impl ::core::convert::From<SupplyCollateralFilter> for IMorphoBaseEvents {
        fn from(value: SupplyCollateralFilter) -> Self {
            Self::SupplyCollateralFilter(value)
        }
    }
    impl ::core::convert::From<WithdrawFilter> for IMorphoBaseEvents {
        fn from(value: WithdrawFilter) -> Self {
            Self::WithdrawFilter(value)
        }
    }
    impl ::core::convert::From<WithdrawCollateralFilter> for IMorphoBaseEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for IMorphoBaseCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for IMorphoBaseCalls {
    ...
    impl ::core::fmt::Display for IMorphoBaseCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<DomainSeparatorCall> for IMorphoBaseCalls {
        fn from(value: DomainSeparatorCall) -> Self {
            Self::DomainSeparator(value)
        }
    }
    impl ::core::convert::From<AccrueInterestCall> for IMorphoBaseCalls {
        fn from(value: AccrueInterestCall) -> Self {
            Self::AccrueInterest(value)
        }
    }
    impl ::core::convert::From<BorrowCall> for IMorphoBaseCalls {
        fn from(value: BorrowCall) -> Self {
            Self::Borrow(value)
        }
    }
    impl ::core::convert::From<CreateMarketCall> for IMorphoBaseCalls {
        fn from(value: CreateMarketCall) -> Self {
            Self::CreateMarket(value)
        }
    }
    impl ::core::convert::From<EnableIrmCall> for IMorphoBaseCalls {
        fn from(value: EnableIrmCall) -> Self {
            Self::EnableIrm(value)
        }
    }
    impl ::core::convert::From<EnableLltvCall> for IMorphoBaseCalls {
        fn from(value: EnableLltvCall) -> Self {
            Self::EnableLltv(value)
        }
    }
    impl ::core::convert::From<ExtSloadsCall> for IMorphoBaseCalls {
        fn from(value: ExtSloadsCall) -> Self {
            Self::ExtSloads(value)
        }
    }
    impl ::core::convert::From<FeeRecipientCall> for IMorphoBaseCalls {
        fn from(value: FeeRecipientCall) -> Self {
            Self::FeeRecipient(value)
        }
    }
    impl ::core::convert::From<FlashLoanCall> for IMorphoBaseCalls {
        fn from(value: FlashLoanCall) -> Self {
            Self::FlashLoan(value)
        }
    }
    impl ::core::convert::From<IsAuthorizedCall> for IMorphoBaseCalls {
        fn from(value: IsAuthorizedCall) -> Self {
            Self::IsAuthorized(value)
        }
    }
    impl ::core::convert::From<IsIrmEnabledCall> for IMorphoBaseCalls {
        fn from(value: IsIrmEnabledCall) -> Self {
            Self::IsIrmEnabled(value)
        }
    }
    impl ::core::convert::From<IsLltvEnabledCall> for IMorphoBaseCalls {
        fn from(value: IsLltvEnabledCall) -> Self {
            Self::IsLltvEnabled(value)
        }
    }
    impl ::core::convert::From<LiquidateCall> for IMorphoBaseCalls {
        fn from(value: LiquidateCall) -> Self {
            Self::Liquidate(value)
        }
    }
    impl ::core::convert::From<NonceCall> for IMorphoBaseCalls {
        fn from(value: NonceCall) -> Self {
            Self::Nonce(value)
        }
    }
    impl ::core::convert::From<OwnerCall> for IMorphoBaseCalls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<RepayCall> for IMorphoBaseCalls {
        fn from(value: RepayCall) -> Self {
            Self::Repay(value)
        }
    }
    impl ::core::convert::From<SetAuthorizationCall> for IMorphoBaseCalls {
        fn from(value: SetAuthorizationCall) -> Self {
            Self::SetAuthorization(value)
        }
    }
    impl ::core::convert::From<SetAuthorizationWithSigCall> for IMorphoBaseCalls {
        fn from(value: SetAuthorizationWithSigCall) -> Self {
            Self::SetAuthorizationWithSig(value)
        }
    }
    impl ::core::convert::From<SetFeeCall> for IMorphoBaseCalls {
        fn from(value: SetFeeCall) -> Self {
            Self::SetFee(value)
        }
    }
    impl ::core::convert::From<SetFeeRecipientCall> for IMorphoBaseCalls {
        fn from(value: SetFeeRecipientCall) -> Self {
            Self::SetFeeRecipient(value)
        }
    }
    impl ::core::convert::From<SetOwnerCall> for IMorphoBaseCalls {
        fn from(value: SetOwnerCall) -> Self {
            Self::SetOwner(value)
        }
    }
    impl ::core::convert::From<SupplyCall> for IMorphoBaseCalls {
        fn from(value: SupplyCall) -> Self {
            Self::Supply(value)
        }
    }
    impl ::core::convert::From<SupplyCollateralCall> for IMorphoBaseCalls {
        fn from(value: SupplyCollateralCall) -> Self {
            Self::SupplyCollateral(value)
        }
    }
    impl ::core::convert::From<WithdrawCall> for IMorphoBaseCalls {
        fn from(value: WithdrawCall) -> Self {
            Self::Withdraw(value)
        }
    }
    impl ::core::convert::From<WithdrawCollateralCall> for IMorphoBaseCalls {
